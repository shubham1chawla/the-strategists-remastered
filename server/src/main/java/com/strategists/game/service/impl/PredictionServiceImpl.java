...
public class PredictionServiceImpl implements PredictionService {
    ...
    private class CSVRow {
        ...
        private final Map<String, PlayerLand> investmentPerLand;
        private final Map<String, List<Rent>> rentsPaidPerLand;
        private final Map<String, List<Rent>> rentsReceivedPerLand;

        private final double totalOwnership;
        private final double totalInvestment;
        private final double totalRentPaid;
        private final double totalRentReceived;
